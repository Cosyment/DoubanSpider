...
def insert(insert_type, title,  # 电视剧名称
           alias,  # 别名
           language,  # 语言
           cover,  # 封面图
           rating,  # 评分
    ...
    sql = "insert into t_television(title,alias,language, cover,rating,year, director, writer, actors, type, release_date,area,count, duration, introduction, trailer,latest,hot) " \
          "values ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(
        title.strip(),
        alias.strip(),
        language.strip(),
    ...
    query_sql = "select title from t_television where title=\'{}'".format(title)
    try:
        # 执行sql语句
