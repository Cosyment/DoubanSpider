...
def insert(insert_type,
    ...
    sql = "insert into t_variety(title,alias,language, cover,rating,year, director, writer, actors, type, release_date,area,count, duration, introduction, trailer,latest,hot) " \
          "values ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}')".format(
        title.strip(),
        alias.strip(),
        language.strip(),
    ...
    query_sql = "select title from t_variety where title=\'{}'".format(title)
    try:
        # 执行sql语句
